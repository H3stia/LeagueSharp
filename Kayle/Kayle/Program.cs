...
namespace Kayle
{
    class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            miscHeal.AddItem(new MenuItem("minManaW", "Min mana % to use W").SetValue(new Slider(50)));
            foreach (var champion in ObjectManager.Get<Obj_AI_Hero>().Where(champion => champion.IsAlly))
            {
                ...
                miscHeal.AddItem(new MenuItem("UseWpercent" + champion.ChampionName, champion.ChampionName + "if HP% less than %").SetValue(new Slider(45)));
            }
